...
const references: LessonReference[] = [
  ...
  { citation: 'Tanaka M et al. Revisions of international consensus Fukuoka guidelines for the management of IPMN of the pancreas. Pancreatology 2017;17:738–753.' },
  { citation: 'European Study Group on Cystic Tumours of the Pancreas. European evidence-based guidelines on pancreatic cystic neoplasms. Gut 2018;67:789–804. (The third major guideline; uses ≥40 mm and MPD 5–9.9 mm as relative indications.)' },
  { citation: 'Vege SS et al. AGA guideline on asymptomatic neoplastic pancreatic cysts. Gastroenterology 2015;148:819–822.' },
  { citation: 'Sahani DV et al. Cystic pancreatic lesions: a simple imaging-based classification. RadioGraphics 2005;25:1471–1484.' },
  { citation: 'Freeny PC, Saunders MD. Moving beyond morphology: characterization and management of cystic pancreatic lesions. Radiology 2014;272:345–363.' },
  { citation: 'Kang MJ et al. Size of main-duct dilatation in IPMN. World J Surg 2015;39:2006–2013. (Source of the ACR 7 mm threshold.)' },
  { citation: 'Zelga P et al. Number of worrisome features and risk of malignancy in IPMN. J Am Coll Surg 2022;234:1021–1030.' },
  { citation: 'Brook OR et al. Delayed growth in incidental pancreatic cysts. Radiology 2016;278:752–761.' },
  { citation: 'Pandey P et al. Follow-up of incidentally detected pancreatic cystic neoplasms: do baseline MRI and CT features predict growth? Radiology 2019;292:647–654.' },
  { citation: 'Han Y et al. Progression of BD-IPMN associates with cyst size. Gastroenterology 2018;154:576–584.' },
  { citation: 'Oyama H et al. Long-term risk of malignancy in BD-IPMN. Gastroenterology 2020;158:226–237.' },
  { citation: 'Marchegiani G et al. Surveillance for presumed BD-IPMN: stability, size, and age identify targets for discontinuation. Gastroenterology 2023;165:1016–1024.' },
  { citation: 'Chernyak V et al. Incidental pancreatic cystic lesions: relationship with PDAC and all-cause mortality. Radiology 2015;274:161–169.' },
  { citation: 'Jais B et al. Serous cystic neoplasm of the pancreas: multinational study of 2622 patients. Gut 2016;65:305–312.' },
  { citation: 'Pozzi-Mucelli RM et al. Pancreatic MRI for surveillance of cystic neoplasms: short versus comprehensive protocol. Eur Radiol 2017;27:41–50.' },
]
