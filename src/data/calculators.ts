...
export const categories: CalculatorCategory[] = [
  {
    ...
    items: [
      ...
      { path: '/studies/liver-lirads', name: 'Liver CT and MRI (LI-RADS)', group: 'Abdomen and pelvis', related: ['/lirads', '/meld'], description: 'Cirrhotic liver observations step by step: major features, ancillary features, LR-TIV and LR-M, and the report.', keywords: ['liver', 'hepatocellular carcinoma', 'hcc', 'cirrhosis', 'li-rads', 'lirads', 'arterial phase hyperenhancement', 'washout', 'capsule', 'threshold growth', 'lesson', 'teaching', 'report', 'template', 'quiz'], component: lazyPage(() => import('../studies/LiverLiradsStudy'), 'LiverLiradsStudyPage') },
      ...
      { path: '/studies/lung-screening-ct', name: 'Lung screening CT (Lung-RADS)', group: 'Chest', related: ['/lungrads'], description: 'Screening LDCT nodules step by step: nodule type, size, growth, category, management and the report.', keywords: ['lung', 'lung cancer screening', 'ldct', 'lung-rads', 'lungrads', 'pulmonary nodule', 'part-solid', 'ground-glass', 'lesson', 'teaching', 'report', 'template', 'quiz'], component: lazyPage(() => import('../studies/LungScreeningCtStudy'), 'LungScreeningCtStudyPage') },
      { path: '/studies/incidental-lung-nodule', name: 'Incidental lung nodule CT (Fleischner)', group: 'Chest', related: ['/fleischner'], description: 'Incidental pulmonary nodules on CT step by step: nodule type, size, risk, Fleischner 2017 follow-up and the report.', keywords: ['lung', 'pulmonary nodule', 'incidental', 'fleischner', 'ground-glass', 'part-solid', 'subsolid', 'follow-up', 'lesson', 'teaching', 'report', 'template', 'quiz'], component: lazyPage(() => import('../studies/IncidentalLungNoduleStudy'), 'IncidentalLungNoduleStudyPage') },
      ...
      { path: '/studies/thyroid-us', name: 'Thyroid ultrasound (TI-RADS)', group: 'Head and neck', related: ['/tirads'], description: 'Thyroid nodules step by step: ACR TI-RADS features and points, FNA and follow-up thresholds, and the report.', keywords: ['thyroid', 'nodule', 'ultrasound', 'ti-rads', 'tirads', 'acr', 'fna', 'neck', 'lesson', 'teaching', 'report', 'template', 'quiz'], component: lazyPage(() => import('../studies/ThyroidUsStudy'), 'ThyroidUsStudyPage') },
    ],
  },
  {
    name: 'Chest',
