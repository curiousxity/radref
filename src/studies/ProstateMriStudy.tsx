...
function build(v: Values) {
  ...
  for (const r of results) {
    ...
    if (epe === 'yes' && r.category < 4) warnings.push(`Lesion ${r.n} is marked with definite EPE but scores PI-RADS ${r.category}: EPE makes a 4 into a 5, so check the ${zone === 'tz' ? 'T2' : 'DWI'} score.`)
